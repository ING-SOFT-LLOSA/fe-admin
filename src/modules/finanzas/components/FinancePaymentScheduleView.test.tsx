...
import FinancePaymentScheduleView from "./FinancePaymentScheduleView";

vi.mock("./steps/ClientSearchStep", () => ({
...
vi.mock("./steps/ContractSelectionStep", () => ({
...
vi.mock("./steps/PaymentManagementStep", () => ({
  default: ({ onBack }: any) => (
