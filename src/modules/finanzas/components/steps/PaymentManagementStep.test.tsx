...
import PaymentManagementStep from "./PaymentManagementStep";

vi.mock("../../hooks/useFinancingData", () => ({
  useFinancingData: vi.fn(),
}));

vi.mock("../details/DirectFinancingView", () => ({
  default: () => <div data-testid="direct-view">Direct Financing</div>,
}));

vi.mock("../details/MortgageFinancingView", () => ({
