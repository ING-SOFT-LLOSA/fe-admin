...
import { updatePagoEstado, uploadPagoComprobante, addPago, deletePago, createCronograma } from "@/lib/api/finanzas";
                        ...
                        <table className="w-full text-left text-sm">
                            ...
                            <tbody className="divide-y divide-slate-50 dark:divide-white/5">
                                {pagos.sort((a, b) => a.nroCuota - b.nroCuota).map((pago) => {
                                    ...
                                    return (
                                        <tr key={pago.uuidPago} className={`transition-colors ${busy ? "opacity-60" : "hover:bg-slate-50/50 dark:hover:bg-white/[0.02]"}`}>
                                            ...
                                            <td className="px-4 py-3">
                                                <InstallmentStatusBadge status={pago.estado} />
                                            </td>
                                            <td className="px-4 py-3">
