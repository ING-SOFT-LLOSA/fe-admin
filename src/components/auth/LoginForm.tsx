        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <div className="flex gap-3 mt-10">
            {["Contratos", "Proyectos", "Clientes", "Analítica"].map((f) => (
              <span
                key={f}
                className="text-[11px] font-semibold text-white/30 border border-white/10 px-3 py-1 rounded-full"
              >
                {f}
              </span>
            ))}
        ...
        <div className="w-full max-w-[360px] animate-slide-up">
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true">
              <path
                fill="#EA4335"
                d="M12 10.2v3.9h5.5c-.2 1.3-1.5 3.8-5.5 3.8-3.3 0-6-2.7-6-6s2.7-6 6-6c1.9 0 3.2.8 4 1.5l2.7-2.6C17 3.3 14.7 2.4 12 2.4 6.9 2.4 2.8 6.5 2.8 11.6s4.1 9.2 9.2 9.2c5.3 0 8.8-3.7 8.8-8.9 0-.6-.1-1.1-.2-1.7H12z"
              />
            </svg>
            Acceder con Google
          </button>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                <span className="material-symbols-outlined absolute left-3.5 top-1/2 -translate-y-1/2 text-[#72787c] text-[18px]">
                  mail
                </span>
                <input
                  type="email"
                  ...
                  placeholder="superadmin@llosa.com"
