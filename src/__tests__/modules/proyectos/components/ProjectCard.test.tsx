...
describe("ProjectCard", () => {
  it("renders project name", () => {
    render(<ProjectCard project={sampleProject} clientesCount={5} dptosCount={20} />);
  ...
  it("shows LEED/EDGE badge when precertificacion is true", () => {
    ...
    render(<ProjectCard project={leedProject} clientesCount={5} dptosCount={20} />);
  ...
  it("shows clientes and dptos counts", () => {
    render(<ProjectCard project={sampleProject} clientesCount={12} dptosCount={85} />);
  ...
  it("hides inicio section when fechaInicio is null", () => {
    ...
    render(<ProjectCard project={noDate} clientesCount={5} dptosCount={20} />);
  ...
  it("shows departamento when distrito is null", () => {
    ...
    render(<ProjectCard project={noDistrito} clientesCount={5} dptosCount={20} />);
  ...
  it("handles missing location gracefully", () => {
    ...
    render(<ProjectCard project={noLocation} clientesCount={5} dptosCount={20} />);
