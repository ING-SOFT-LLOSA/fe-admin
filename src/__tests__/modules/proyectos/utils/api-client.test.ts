...
import { createProject, createInventory, generateEstructura } from '@/modules/proyectos/utils/api-client';
import type { ProjectFormData, InventoryConfig } from '@/modules/proyectos/utils/wizard-logic';
