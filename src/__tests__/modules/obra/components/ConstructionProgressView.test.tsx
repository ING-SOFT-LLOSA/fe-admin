...
// ---------------------------------------------------------------------------
vi.mock('@/modules/obra/components/ObraTabHitos', () => ({
...
vi.mock('@/modules/obra/components/ObraTabReportes', () => ({
  default: vi.fn((props: any) => {
...
vi.mock('@/modules/obra/components/ObraTabDocumentacion', () => ({
  default: () => <div data-testid="tab-documentacion">Documentación</div>,
}));

vi.mock('@/modules/obra/components/ObraTabTimeline', () => ({
  default: vi.fn((props: any) => {
